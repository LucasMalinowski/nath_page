...
export default function GaleriaPage() {
  ...
  return (
      ...
      <main ref={revealRootRef} id="galeria" className="min-h-screen bg-[#ede8df] text-[#3b2f26] page-fade-in">
        ...
        {/* Obras em Exposição */}
        <section className="bg-[#ede8df] pt-16 sm:pt-20 lg:pt-24" id="obras">
          <div className="mb-12 flex flex-wrap items-end justify-between gap-6 px-6 sm:mb-16 sm:px-8 lg:px-16">
          ...
          {loading && (
            <p className="px-6 pb-16 font-sans text-[#8a7560] sm:px-8 lg:px-16">Carregando...</p>
          )}
